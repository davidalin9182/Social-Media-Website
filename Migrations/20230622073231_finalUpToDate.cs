...
{
    public partial class finalUpToDate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Friend_AspNetUsers_AppuserId",
                        column: x => x.AppuserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostProfileImage = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostsViewModelId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostsViewModel", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PostsViewModel_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PostsViewModel_PostsViewModel_PostsViewModelId",
                        column: x => x.PostsViewModelId,
                        principalTable: "PostsViewModel",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommentViewModelId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CommentViewModel_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CommentViewModel_CommentViewModel_CommentViewModelId",
                        column: x => x.CommentViewModelId,
                        principalTable: "CommentViewModel",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CommentViewModel_Posts_PostsId",
                        column: x => x.PostsId,
                        principalTable: "Posts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CommentViewModel_PostsViewModel_PostsViewModelId",
                        column: x => x.PostsViewModelId,
                        principalTable: "PostsViewModel",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Likes_PostsViewModel_PostsViewModelId",
                        column: x => x.PostsViewModelId,
                        principalTable: "PostsViewModel",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommentViewModel_AppUserId",
                table: "CommentViewModel",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_CommentViewModel_CommentViewModelId",
                table: "CommentViewModel",
                column: "CommentViewModelId");

            migrationBuilder.CreateIndex(
                name: "IX_CommentViewModel_PostsId",
                table: "CommentViewModel",
                column: "PostsId");

            migrationBuilder.CreateIndex(
                name: "IX_CommentViewModel_PostsViewModelId",
                table: "CommentViewModel",
                column: "PostsViewModelId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Likes_PostsViewModelId",
                table: "Likes",
                column: "PostsViewModelId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostsViewModel_AppUserId",
                table: "PostsViewModel",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_PostsViewModel_PostsViewModelId",
                table: "PostsViewModel",
                column: "PostsViewModelId");
        }
